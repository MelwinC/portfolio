            ...
            <div className="container mx-auto text-ternary-light">
                <div>
                    ...
                    <p className="text-lg mt-14 text-center">
                        Le Brevet de Technicien Supérieur Services Informatiques aux Organisations est un diplôme d'état de niveau 5. <br />
                    ...
                    <div className="grid grid-cols-2 divide-x mt-12">
                        ...
                        <div>
                            <ul className="list-disc ml-10">
                                <h3 className="text-xl font-semibold text-center">Option SISR <br /> <span className="text-lg">(Solutions d'Infrastructures Systèmes et Réseaux)</span></h3>
                                <li className="text-sm text-indigo-300 mt-6">
