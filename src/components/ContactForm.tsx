                    ...
                    <ul className="font-general-regular">
                        <li className="flex justify-center">
                            <i className="text-2xl text-gray-500 dark:text-gray-400 mr-4">
                                <svg className='text-indigo-400' stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
